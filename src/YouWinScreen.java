...
public class YouWinScreen implements Animation {
     ...
     * @param gameScore current score.
     */
    public YouWinScreen(KeyboardSensor k, int gameScore) {
     ...
     * @param gameScore current score.
     */
    public YouWinScreen(int gameScore, KeyboardSensor k, GameLevel callerRef) {
        this.score = gameScore;
        this.keyboard = k;
    ...
    public void doOneFrame(DrawSurface d) {
        d.drawText(
                10,
                d.getHeight() / 2,
                "YAY You win. You should be proud. SCORE: " + score,
                32
        );
    }
